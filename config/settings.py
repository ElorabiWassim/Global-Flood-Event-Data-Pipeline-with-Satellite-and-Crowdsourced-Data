...
# Paths
# ---------------------------------------------------------------------------
# Repository root is the parent of this file's package: <root>/config/settings.py
...
RELIEFWEB_APPNAME: str = os.getenv("RELIEFWEB_APPNAME", "ai-students-flood-project-mkh59")
